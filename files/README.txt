...
ALSO PUT HERE:
    cover.jpg    your front cover, about 600px wide, JPG or PNG.
                 It appears in the header of both pages automatically.
                 If the file is missing the image just hides itself,
                 so nothing breaks.
...
STILL TO DO:
    ...
    cover.jpg
    Your front cover, ~600px wide. Appears in the page header automatically.
